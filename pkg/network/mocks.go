...
// NewMockAdvancedConn creates a new instance of MockAdvancedConn. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
...
func (_m *MockAdvancedConn) EXPECT() *MockAdvancedConn_Expecter {
	return &MockAdvancedConn_Expecter{mock: &_m.Mock}
}
...
func (_e *MockAdvancedConn_Expecter) Close() *MockAdvancedConn_Close_Call {
	return &MockAdvancedConn_Close_Call{Call: _e.mock.On("Close")}
}
...
func (_e *MockAdvancedConn_Expecter) Conn() *MockAdvancedConn_Conn_Call {
	return &MockAdvancedConn_Conn_Call{Call: _e.mock.On("Conn")}
}
...
func (_e *MockAdvancedConn_Expecter) Read() *MockAdvancedConn_Read_Call {
	return &MockAdvancedConn_Read_Call{Call: _e.mock.On("Read")}
}
...
func (_e *MockAdvancedConn_Expecter) Write(m interface{}) *MockAdvancedConn_Write_Call {
	return &MockAdvancedConn_Write_Call{Call: _e.mock.On("Write", m)}
}
